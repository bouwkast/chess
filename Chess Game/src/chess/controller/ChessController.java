...
public class ChessController {
   ...
   //private Timer countdownTimerp2;
    ...
    private void updatePassantPieces (int row, int col) {
        gui.getButtonAt(row, col).setText("");
    ...
    /***
     * ****************************************************************
     * A method to toggle which timer should go down. 
     * If whitePlayerTimer is true, it is Player 1's turn and
     * their timer should go down. If whitePlayerTime is false, it 
     * is Player two's turn and their timer should go down instead
     * @param TurnPlayer
    *****************************************************************
     */
