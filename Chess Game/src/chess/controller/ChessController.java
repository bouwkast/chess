...
public class ChessController {
	...
	/*******************************************************************
	 * Constructor for the Controller part of the MVC Takes in both the GUI and
	 * the game as parameters and adds the ChessListener onto the GUI.
	 * 
	...
	class ChessListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (firstClick) {
				...
				if (game.checkMove(r1, c1, r2, c2, game.getPieceAt(r1, c1))) {
